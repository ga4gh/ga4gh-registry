...
public class StandardVersionTest {
    ...
    private class TestCase {
        ...
        public TestCase(UUID id, Standard standard, String versionNumber, String documentationUrl, ReleaseStatus releaseStatus, List<Implementation> implementations, String expString) {
            this.id = id;
    ...
    public Object[][] getData() {
        return new Object[][] {
            {new TestCase(
                UUID.fromString("dca47919-ee0f-4b57-9001-3eb6aa81d863"),
            ...
            {new TestCase(
                UUID.fromString("1d639704-93d6-4ed9-a60a-8540c6cef3eb"),
            ...
            {new TestCase(
                UUID.fromString("2f60f4bf-d7a9-4eb5-95f5-030e1790e3a4"),
