...
public class WorkStreamTest {
    ...
    private class TestCase {
        ...
        public TestCase(UUID id, String name, String abbreviation,
    ...
    public Object[][] getData() {
        return new Object[][] {
            {new TestCase(
                UUID.fromString("4113c564-1fbb-40fe-8bad-e6ba5e675e9c"),
            ...
            {new TestCase(
                UUID.fromString("5125077d-041e-43ce-b9c9-f584153d972e"),
                "Cloud",
                null,
                new ArrayList<Standard>() {{
                    add(new Standard(
            ...
            {new TestCase(
                UUID.fromString("210c6773-10ad-489a-82d6-72ffa548af0f"),
