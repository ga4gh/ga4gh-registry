...
public class ReleaseStatusTest {
    ...
    private class TestCase {
        ...
        public TestCase(UUID id, String status, List<Standard> standards, List<StandardVersion> standardVersions, String expString) {
            this.id = id;
            this.status = status;
    ...
    public Object[][] getData() {
        return new Object[][] {
            {new TestCase(
                UUID.fromString("03f89c73-c703-4603-8579-fe4c38d94a6a"),
                "Approved",
